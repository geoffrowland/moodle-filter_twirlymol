...
//  Fix reading of element symbols
...
/*      p.spheres[i].setFill({type:"radial", cx:-1, cy:-1.5, r:radius/1.5,
        colors:[{color:[255, 255, 255, 1], offset:0},
                {color:[col[0], col[1], col[2], 1], offset:1}]});  */     
...
/*        sphere.setFill([col[0], col[1], col[2], alpha]); */
          sphere.setFill({type:"radial", cx:-1, cy:-1.5, r:3.5,
          colors:[{color:[255, 255, 255, alpha], offset:0},
          {color:[col[0], col[1], col[2], alpha], offset:1}]});
      }
    }
...
var tl_CPK = [[-1, -1, -1], [215, 215, 215], [216, 255, 255], [204, 127, 255], [193, 255, 0], [255, 181, 181], [127, 127, 127], [12, 12, 255], [255, 12, 12], [178, 255, 255], [178, 226, 244], [170, 91, 242], [137, 255, 0], [191, 165, 165], [127, 153, 153], [255, 127, 0], [255, 255, 48], [30, 239, 30], [127, 209, 226], [142, 63, 211], [61, 255, 0], [229, 229, 229], [191, 193, 198], [165, 165, 170], [137, 153, 198], [155, 122, 198], [224, 102, 51], [112, 122, 198], [91, 122, 193], [255, 122, 96], [124, 127, 175], [193, 142, 142], [102, 142, 142], [188, 127, 226], [255, 160, 0], [165, 40, 40], [91, 183, 209], [112, 45, 175], [0, 255, 0], [147, 255, 255], [147, 224, 224], [114, 193, 201], [84, 181, 181], [58, 158, 158], [35, 142, 142], [10, 124, 140], [0, 104, 132], [224, 224, 255], [255, 216, 142], [165, 117, 114], [102, 127, 127], [158, 99, 181], [211, 122, 0], [147, 0, 147], [66, 158, 175], [86, 22, 142], [0, 201, 0], [112, 211, 255], [255, 255, 198], [216, 255, 198], [198, 255, 198], [163, 255, 198], [142, 255, 198], [96, 255, 198], [68, 255, 198], [48, 255, 198], [30, 255, 198], [0, 255, 155], [0, 229, 117], [0, 211, 81], [0, 191, 56], [0, 170, 35], [76, 193, 255], [76, 165, 255], [33, 147, 214], [38, 124, 170], [38, 102, 150], [22, 84, 135], [244, 237, 209], [204, 209, 30], [181, 181, 193], [165, 84, 76], [86, 89, 96], [158, 79, 181], [170, 91, 0], [117, 79, 68], [66, 130, 150], [66, 0, 102], [0, 124, 0], [112, 170, 249], [0, 186, 255], [0, 160, 255], [0, 142, 255], [0, 127, 255], [0, 107, 255], [84, 91, 242], [119, 91, 226], [137, 79, 226], [160, 53, 211], [178, 30, 211], [178, 30, 186], [178, 12, 165], [188, 12, 135], [198, 0, 102], [204, 0, 89], [209, 0, 79], [216, 0, 68], [224, 0, 56], [229, 0, 45], [232, 0, 38], [234, 0, 35], [237, 0, 33], [239, 0, 30], [242, 0, 28], [244, 0, 25], [247, 0, 22], [249, 0, 20], [252, 0, 17], [255, 0, 15]];
//tl_CPK[1] = [0, 0, 0];
function twirlyMol(elemID, atoms, bonds, elements, fog){
  ...
  //  Drop back to legacy div height and width attributes if div style height (only) not set. NB div width defaults to 100% if not set.
  //if (h == 0){
  //   var w = container.getAttribute("width");
  //   var h = container.getAttribute("height");
  //}
  ...
  //   scale: min(h,w) / 20, width:w, height:h,
       scale: min(h,w) / 15, width:w, height:h,
  //   scale: min(h,w) / 10, width:w, height:h,
  //   scale: min(h,w) / 5, width:w, height:h,
